...
export const adminIsAdmin = createServerFn({ method: "POST" }).handler(
  async () => {
    try {
...
export const adminClaimIfFirst = createServerFn({ method: "POST" }).handler(
  async () => {
...
export const adminListMeetings = createServerFn({ method: "POST" }).handler(
  async () => {
...
export const adminListBuyOuts = createServerFn({ method: "POST" }).handler(
  async () => {
    await requireAdminUserId();
...
export const adminGetSettings = createServerFn({ method: "POST" }).handler(
  async () => {
    await requireAdminUserId();
    const { data, error } = await supabaseAdmin
      .from("settings")
...
export const adminGetOverview = createServerFn({ method: "POST" }).handler(
  async () => {
    await requireAdminUserId();
